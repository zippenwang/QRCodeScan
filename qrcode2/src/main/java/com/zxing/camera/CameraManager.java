...
//	private static final int MAX_FRAME_HEIGHT = 675; // = 5/8 * 1080
	...
	private final int MAX_FRAME_WIDTH; // = 5/8 * 1920
	private final int MAX_FRAME_HEIGHT; // = 5/8 * 1080
	...
	public CameraManager(Context context) {
		...
		MIN_FRAME_WIDTH = DensityUtil.dp2px(context, 240);
		MIN_FRAME_HEIGHT = DensityUtil.dp2px(context, 240);
		MAX_FRAME_WIDTH = DensityUtil.dp2px(context, 1200); // = 5/8 * 1920
		MAX_FRAME_HEIGHT = DensityUtil.dp2px(context, 675); // = 5/8 * 1080
	}
...
//					topOffset + height);
			...
			framingRect = new Rect(leftOffset, topOffset, leftOffset + tmp, topOffset + tmp);
