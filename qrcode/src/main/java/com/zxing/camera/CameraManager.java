...
//	private static final int MAX_FRAME_HEIGHT = 600;
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			final int MIN_FRAME_WIDTH = DensityUtil.dp2px(context, 240);
			final int MIN_FRAME_HEIGHT = DensityUtil.dp2px(context, 240);
			final int MAX_FRAME_WIDTH = DensityUtil.dp2px(context, 1200); // = 5/8 * 1920
			final int MAX_FRAME_HEIGHT = DensityUtil.dp2px(context, 675); // = 5/8 * 1080
